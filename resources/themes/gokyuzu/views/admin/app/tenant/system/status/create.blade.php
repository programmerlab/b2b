...
@section('boxContent')
    <form id="{!! $appRouter['current']['as'] !!}" data-action="{!! route_action('add') !!}" class="ui form">
        ...
        <div class="field lang">
            ...
            @include('admin::_parts.lang.tenant.lang', ['id' => 'title', 'layout' => 'text_create'])
        </div>
        <div class="three fields">
            <div class="field">
                <label for="">Ikon</label>
                @include('admin::_parts.dropdown.icons', ['name' => 'icon_definition_id'])
            </div>
            <div class="field">
                <label for="">Yazı Rengi</label>
                <input name="text_color" value="" placeholder="Yazı Rengi" type="text">
            </div>
            <div class="field">
                <label for="">Arkaplan Rengi</label>
                <input name="bg_color" value="" placeholder="Arkaplan Rengi" type="text">
            </div>
        </div>
        <div class="field">
