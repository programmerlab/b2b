    ...
    <form id="{!! $appRouter['current']['as'] !!}" data-action="{!! route_action('update') !!}" class="ui form">
        ...
        <div class="field">
            ...
            <div class="ui selection dropdown">
                <input type="hidden" name="main_role" value="{!! $row['role']['role_id'] !!}">
...
@section('boxAfter')
    ...
    <div class="ui fluid steps tabular no margin top bottom">
        ...
        <a class="step item" data-tab="tabUserTenantGetIndex">
            <i class="database icon"></i>
            <div class="content">
                <div class="title">Uygulamalar</div>
                <div class="description">Kullanıcının baglı olduğu uygulamalar</div>
            </div>
        </a>
    ...
    <div style="min-height: 500px; margin-top: 20px">
        ...
        <div class="ui tab " data-tab="tabUserTenantGetIndex">
            <div id="loadUserTenantGetIndex"></div>
            <div id="buttonUserTenantGetIndex"></div>
        </div>
...
@section('jsCode')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#buttonUserTenantGetIndex').on('click', function() {
                App.load('#loadUserTenantGetIndex', '{!! route_name('userTenantGetIndex', 'user='.$row['id']) !!}');
            });

            $('#buttonNoteGetIndex').click();
            $('#buttonLogGetIndex').click();
            $('#buttonUserAddressGetIndex').click();
            $('#buttonUserTenantGetIndex').click();
        });
    </script>
@stop