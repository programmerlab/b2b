...
@section('boxContent')
    <form id="{!! $appRouter['current']['as'] !!}" data-action="{!! route_action('update') !!}" class="ui form">
        ...
        <input name="menu_id" value="{!! $row['menu_id'] !!}" type="hidden">
                ...
                <div class="fields two">
					<div class="field">
						...
						<div class="ui selection dropdown">
							<input type="hidden" name="accessory[target]" value="{!! $row['target'] !!}">
                    ...
                    <div class="field">
                        ...
                        @include('admin::_parts.dropdown.icons', ['name' => 'accessory[icon_definition_id]', 'value' => $row['icon_definition_id']])
                    </div>
                </div>
				<div class="field">
					<label for="">Link Html Class</label>
					<input name="accessory[item_class]" value="{!! $row['item_class'] !!}" placeholder="Link Html Class" type="text">
				</div>
                <div class="fields two">
                    <div class="field">
                        <label for="">Yazi Rengi</label>
                        <input name="accessory[text_color]" value="{!! $row['text_color'] !!}" class="color picker" placeholder="Yazı Rengi" type="text">
                    </div>
                    <div class="field">
                        <label for="">Arkaplan Rengi</label>
                        <input name="accessory[bg_color]" value="{!! $row['bg_color'] !!}" class="color picker" placeholder="Arkaplan Rengi" type="text">
                    </div>
                </div>
            </div>
        </div>
